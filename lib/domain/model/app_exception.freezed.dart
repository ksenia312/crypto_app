...
class _$CryptoListFetchErrorImpl implements CryptoListFetchError {
  const _$CryptoListFetchErrorImpl();

  @override
  String toString() {
    return 'AppException.cryptoListFetchError()';
  }
...
abstract class CryptoListFetchError implements AppException {
  const factory CryptoListFetchError() = _$CryptoListFetchErrorImpl;
}
